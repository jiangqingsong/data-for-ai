...
- [x] **Step 1: 编写 01-rag-architecture.md**
...
- [x] **Step 2: 编写 02-data-pipeline.md**（核心概念框架，实验记录边做边填）
...
- [x] **Step 3: 编写 03-embedding-vectorstore.md**（框架）
...
- [x] **Step 4: 编写 05-prompt-engineering.md**（框架）
